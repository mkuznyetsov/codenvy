...
public class TestNodeManagerHelperCodenvy4Impl extends BaseTest {
    ...
    public void testGetUpdatePuppetConfigCommand() throws Exception {
        ...
        doReturn(Config.SWARM_NODES).when(mockNodeConfigHelper).getPropertyNameBy(NodeConfig.NodeType.MACHINE_NODE);
    ...
    public void testRecognizeNodeTypeFromConfigBy() throws Exception {
        doReturn(NodeConfig.NodeType.MACHINE_NODE).when(mockNodeConfigHelper).recognizeNodeTypeFromConfigBy(TEST_NODE_DNS);
    ...
    public void testGetPropertyNameBy() throws Exception {
        doReturn(ADDITIONAL_NODES_PROPERTY_NAME).when(mockNodeConfigHelper).getPropertyNameBy(NodeConfig.NodeType.RUNNER);
