...
public class TestNodeManagerHelperCodenvy3Impl extends BaseTest {
    ...
    public void testRecognizeNodeTypeFromConfigBy() throws Exception {
        doReturn(NodeConfig.NodeType.RUNNER).when(mockNodeConfigHelper).recognizeNodeTypeFromConfigBy(TEST_NODE_DNS);
    ...
    public void testGetPropertyNameBy() throws Exception {
        doReturn(ADDITIONAL_RUNNERS_PROPERTY_NAME).when(mockNodeConfigHelper).getPropertyNameBy(NodeConfig.NodeType.RUNNER);
